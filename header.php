...
<head>
    ...
    <?php
    //Set up a changing page title on each page
    echo "<title>Big Blooming Aberdeen - $pageTitle</title>"
    ?>
</head>
<body>
<header>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand" href="index.php"><img src="/assets/images/Bloomingbiglogo.png"
                                                          alt="Big Blooming Aberdeen Logo"/></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                //Change the header based on the user logged in
                session_start();
